						...
						<div class="col-right">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="start" id="start" data-select="datepicker" value="<?php echo ($ticket->start != '0000-00-00 00:00:00' ? date('d/m/Y H:i:s', strtotime($ticket->start)) : '') ?>">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="due" id="due" data-select="datepicker" value="<?php echo ($ticket->due != '0000-00-00 00:00:00' ? date('d/m/Y H:i:s', strtotime($ticket->due)) : '') ?>">
									<span class="input-group-btn"><button type="button" class="btn btn-primary" data-toggle="datepicker"><i class="fa fa-calendar"></i></button></span>
								</div>
							</div>
							<!--  -->
