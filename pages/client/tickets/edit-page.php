						...
						<div class="col-right">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" class="form-control" name="start" id="start" data-select="datepicker" value="<?php echo ($ticket->start != '0000-00-00 00:00:00' ? date('d/m/Y', strtotime($ticket->start)) : '') ?>">
